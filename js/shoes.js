var features = [
    {
        ...
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
                            doloremque, vel aut! Eius totam sed numquam.`
    },
    {
        'id': 2,
        'name': 'Peak DH3 Mens',
    ...
    {
        'id': 3,
        'name': 'Fun-Running VII',
        'images': ['3-1.png', '3-2.png', '3-3.png', '3-4.png'],
        'sizes': ['M', 'L'],
        'colors': ['#fff', '#E92E30', '#000'],
        'price': 146.55,
        'discount': 0.20,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
    ...
    },
    {
        'id': 8,
        'name': 'Don Issue 3',
        'images': ['8-1.png', '8-2.png', '8-3.png'],
        'sizes': ['M', 'XL'],
        'colors': ['#000', '#4A4680', '#930621'],
        'price': 176.00,
        'discount': 0.13,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
    ...
    {
        'id': 11,
        'name': 'Triumph 19 Women',
        'images': ['11-1.png', '11-2.png', '11-3.png'],
        'sizes': ['M', 'L'],
        'colors': ['#000', '#A94F8A', '#fff'],
        'price': 215.00,
        'discount': 0.12,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
    ...
    {
        'id': 13,
        'name': 'On Cloudflyer Men',
        'images': ['13-1.png', '13-2.png', '13-3.png'],
        'sizes': ['M', 'L'],
        'colors': ['#3F4A58', '#B3B9B2', '#DDDDD2'],
        'price': 213.00,
        'discount': 0.0,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
    ...
    },
    {
        'id': 14,
        'name': 'Aero Wave 19',
        'images': ['14-1.png', '14-2.png', '14-3.png'],
        'sizes': ['S'],
        'colors': ['#E52940'],
        'price': 188.25,
        'discount': 0.0,
    ...
    {
        'id': 15,
        'name': "NIKE Women's Hyperace",
        'images': ['15-1.png', '15-2.png', '15-3.png', '15-4.png'],
        'sizes': ['M', 'L'],
        'colors': ['#000', '#008A68', '#B42D32', '#32487B'],
        'price': 178.25,
        'discount': 0.12,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
    ...
    {
        'id': 16,
        'name': "NIKE Man's Hyperace",
        'images': ['16-1.png', '16-2.png'],
        'sizes': ['M', 'XL'],
        'colors': ['#FCDA9F', '#DCC4AA'],
        'price': 188.00,
        'discount': 0.15,
        'description': `Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur, aspernatur. Eveniet,
                            fugiat recusandae voluptatum odio placeat aperiam impedit architecto quod modi, possimus qui
...
var latest = [
    {
        'id': 17,
        'name': 'New Nike Black Airmax Shoes',
        ...
        'description': `Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nisi modi minus eum debitis in?
                        ...
                        inventore soluta sunt voluptates nisi esse. Reprehenderit dolorem qui, dolores
                        asperiores fuga illo eligendi!`
    },
    {
        'id': 18,
        'name': 'New Nike White Airmax Shoes',
    ...
    {
        'id': 19,
        'name': 'New Nike Mix Airmax Shoes',
